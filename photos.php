...
if($u == $log_username && $user_ok == true){
	$isOwner = "yes";
	///////////////////////////////////////////////////////////////////////////
	//  INSERT FORM OR FROM ELEMENTS HERE TO ALLOW USER TO CREATE THEIR OWN  //
	//  GALLERIES. WILL NEED A NEW DATABASE TABLE CALLED USER_GALLERIES TO   //
	//  PLACE GALLERY NAMES AND HAVE A PLACE WHERE THEY CAN BE CALLED.       //
	///////////////////////////////////////////////////////////////////////////
	$photo_form  = '<form enctype="multipart/form-data" method="post" action="php_parsers/photo_system.php">';
	$photo_form .=   '<legend>Hi '.$u.', Upload new photos?</legend>';
	$photo_form .=   '<strong>Choose Gallery:</strong> ';
	$photo_form .=   '<select class="input-block-level" name="gallery" required>';
	...
	$photo_form .=   '<strong>Choose Photo:</strong> ';
	$photo_form .=   '<input  class="input-medium" type="file" name="photo" accept="image/*" required>';
	$photo_form .=   '<p><input class="btn btn-medium pull-right" type="submit" value="Upload Photo Now"></p>';
	$photo_form .= '</form>';
}
