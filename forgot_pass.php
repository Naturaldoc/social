...
if(isset($_POST["e"])){
	...
	if($numrows > 0){
		...
		$msg = '<h2>Hello '.$u.'</h2>
				<p>This is an automated message from Social Campus. If you did not recently initiate the Forgot Password
				process, please disregard this email.</p>
				<p>You indicated that you forgot your login password. We can generate a temporary password for you to log
				in with, then once logged in you can change your password to anything you like.</p>
				<p>After you click the link below your password to login will be:<br /><strong>'.$tempPass.'</strong></p>
				<p><a href="http://school.mousetech.org/forgot_pass.php?u='.$u.'&p='.$hashTempPass.'">Click here now to
				apply the temporary password shown below to your account</a></p>
				<p>If you do not click the link in this email, no changes will be made to your account. In order to set
				your login password to the temporary password you must click the link above.</p>';
		...
		<div class="hero-unit span6 offset2">
			...
			<form id="forgotpassform" onsubmit="return false;">
				<fieldset>
					...
					<input class="input-xlarge" placeholder="Email Address" id="email" type="text" onfocus="_('status').innerHTML='';" maxlength="88">
					<br />
